...
<section id="contact" class="contact" style="background-color: #ee244b;">
  <div class="container">
    ...
    <div class="section-title">
      <h2>Contact</h2>
      <p style="color: #791329;">" Our experienced team is dedicated to providing top-notch event organization services for all types of racing events. Whether you're a professional racing team or an amateur enthusiast, we have the right resources and expertise to make your event a success. Contact us today to learn more about how we can help you plan and execute an unforgettable racing experience."</p>
    </div>
  </div>
