...
<head>
  ...
  <!-- Main CSS File -->
  <link href="assets/css/transparent.css" rel="stylesheet">
...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center px-3 sticky-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="./UserHomePage.php" class="logo d-flex align-items-center">
       
        <img src="assets/img/D LOGO.png"  alt="">
        <!-- <h1 class="sitename">Initial Dream</h1> -->
      </a>
  ...
  <main class="main">
    ...
    <!-- ======= Services Section ======= -->
<section id="services" class="about section transparent-background">
  <div class="container">
