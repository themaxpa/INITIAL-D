...
<style>
  * {
  ...
  #hero {
    background-image: url('./assets/img/slide-x.jpg');
    background-size: cover;
  }

  #imgRC {
    background-image: url("assets/img/thumb_2877_380_250_0_0_crop.jpg");
    margin-top: 40px;
  }
...
--------------------------------------------------------------*/
  ...
  @media (max-width: 480px) {
    ...
    #hero {
      background-image: url('./assets/img/phone393/ph12.jpg');
      background-size: cover;
    }
  ...
  <section id="" class="feature-rt">
    <div class="container">
      <div class="section-title">
        <h2 class="h1-txt">Test dates find you from now on!</h2>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
          <div id="imgRC" class="col-lg-5 align-items-stretch order-1 order-lg-2 img">&nbsp;</div>
